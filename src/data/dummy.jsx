...
export const kanbanGrid = [
  { headerText: 'براي انجام',
    keyField: 'Open',
    allowToggle: true },

  { headerText: 'درحال انجام',
    keyField: 'InProgress',
    allowToggle: true },

  { headerText: 'درحال تست',
    keyField: 'Testing',
    allowToggle: true,
    isExpanded: false },
...
export const EditorData = () => (
  <div>
    <h3>
    React را امتحان کنید
       React از ابتدا برای پذیرش تدریجی طراحی شده است، و شما می توانید به همان میزان که نیاز دارید از React استفاده کنید. چه بخواهید طعم React را بچشید، یا مقداری تعامل به یک صفحه HTML ساده اضافه کنید یا یک برنامه پیچیده مبتنی بر React را راه اندازی کنید، پیوندهای موجود در این بخش به شما در شروع کار کمک می کنند.

       زمین های بازی آنلاین
       اگر علاقه مند به بازی با React هستید، می توانید از یک زمین بازی کد آنلاین استفاده کنید. یک الگوی Hello World را در CodePen، CodeSandbox یا Stackblitz امتحان کنید.

       اگر ترجیح می دهید از ویرایشگر متن خود استفاده کنید، می توانید این فایل HTML را نیز دانلود کنید، آن را ویرایش کنید و از سیستم فایل محلی در مرورگر خود باز کنید. این یک تبدیل کد زمان اجرا کند انجام می دهد، بنابراین ما فقط استفاده از آن را برای دموهای ساده توصیه می کنیم.

       React را به یک وب سایت اضافه کنید
       می توانید React را در یک دقیقه به صفحه HTML اضافه کنید. سپس می توانید به تدریج حضور آن را گسترش دهید یا آن را در چند ویجت پویا نگه دارید.

       یک React App جدید ایجاد کنید
       هنگام شروع یک پروژه React، یک صفحه HTML ساده با برچسب های اسکریپت ممکن است بهترین گزینه باشد. راه اندازی فقط یک دقیقه طول می کشد!

       همانطور که برنامه شما رشد می کند، ممکن است بخواهید یک راه اندازی یکپارچه تر را در نظر بگیرید. چندین زنجیره ابزار جاوا اسکریپت وجود دارد که ما برای برنامه های بزرگتر توصیه می کنیم. هر یک از آن‌ها می‌توانند بدون پیکربندی کار کنند و به شما امکان می‌دهند از اکوسیستم غنی React نهایت استفاده را ببرید. یاد بگیرند که چگونه.

       React را یاد بگیرید
       افراد از پس زمینه های مختلف و با سبک های یادگیری متفاوت به React می آیند. چه رویکرد نظری تر یا عملی را ترجیح دهید، امیدواریم این بخش برای شما مفید واقع شود.

       اگر ترجیح می دهید با انجام کار یاد بگیرید، با آموزش عملی ما شروع کنید.
       اگر ترجیح می دهید مفاهیم را گام به گام یاد بگیرید، با راهنمای ما برای مفاهیم اصلی شروع کنید.
       مانند هر فناوری ناآشنا، React منحنی یادگیری دارد. با تمرین و کمی حوصله به نتیجه خواهید رسید.

       اولین نمونه ها
       صفحه اصلی React حاوی چند نمونه کوچک React با ویرایشگر زنده است. حتی اگر هنوز چیزی در مورد React نمی‌دانید، سعی کنید کد آن‌ها را تغییر دهید و ببینید که چگونه روی نتیجه تأثیر می‌گذارد.

       برای مبتدیان واکنش نشان دهید
       اگر احساس می‌کنید که مستندات React با سرعتی سریع‌تر از آنچه راحت هستید پیش می‌رود، این نمای کلی از React توسط تانیا راشیا را بررسی کنید. مهم ترین مفاهیم React را به روشی دقیق و مبتدی معرفی می کند. پس از اتمام، اسناد را دوباره امتحان کنید!

       واکنش برای طراحان
       اگر از پس زمینه طراحی می آیید، این منابع مکانی عالی برای شروع هستند.

       منابع جاوا اسکریپت
       مستندات React آشنایی با برنامه نویسی در زبان جاوا اسکریپت را فرض می کند. لازم نیست متخصص باشید، اما یادگیری همزمان React و JavaScript دشوارتر است.

       توصیه می کنیم برای بررسی سطح دانش خود از این مرور کلی جاوا اسکریپت استفاده کنید. بین 30 دقیقه تا یک ساعت طول می کشد، اما با یادگیری React با اطمینان بیشتری احساس خواهید کرد.
    </h3>
  </div>
);
...
export const links = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        name1:"نمودار نقطه ای",
        name: 'bar',
        icon: <AiOutlineBarChart />,
      },
      {
        name1:"نمودار دایره ای",
        name: 'pie',
        icon: <FiPieChart />,
      },
      {
...
export const medicalproBranding = {
  data: [
    ...
    {
      title: 'بودجه',
      desc: "120,365,000 تومان",
    },
    {
      title: 'هزینه',
      desc: '48,800,000 تومان',
    },
  ],
  teams: [
    {
...
export const ordersData = [
  ...
  {
    OrderID: 390457,
    CustomerName: 'منا سلیمانی',
    TotalAmount: 93,
    OrderItems: 'شکلات تخته ای',
    Location: 'پرند',
  ...
  {
    OrderID: 893486,
    CustomerName: 'علی مسلمی',
    TotalAmount: 93,
    OrderItems: 'چراغ خواب',
    Location: 'کرج',
    Status: 'کنسل شده',
    StatusBg: '#FF5C8E',
    ProductImage:
  ...
  {
    OrderID: 748975,
    CustomerName: 'زهره عشقی',
    TotalAmount: 23,
    OrderItems: 'مراقب پوستی',
    Location: 'شیراز',
    Status: 'مرجوع شده',
    StatusBg: 'red',
    ProductImage:
  ...
  {
    OrderID: 94757,
    CustomerName: 'مینا نامداری',
    TotalAmount: 95,
    OrderItems: 'آرایش لانکوم روژ',
    Location: 'رشت',
    Status: 'کنسل شده',
    StatusBg: '#FF5C8E',
    ProductImage:
  ...
  {
    OrderID: 944895,
    CustomerName: 'عباس بوعذار',
    TotalAmount: 17.99,
    OrderItems: 'ساعت',
    Location: 'طهران',
    Status: 'ارسال از انبار',
    StatusBg: '#03C9D7',
    ProductImage:
      product3,
  },
...
export const kanbanData = [
  ...
  },
  {
    ...
    Title: 'Task - 29017',
    Status: 'Review',
    Summary: 'مشکلات گزارش شده در اتصال داده را برطرف کنید.',
    Type: 'Story',
    Priority: 'Normal',
    Tags: 'Databinding',
    Estimate: '3.5',
  ...
  },
  {
    ...
    Title: 'Task - 29018',
    Status: 'Close',
    Summary: 'اتصال SQL Server 2008 را تجزیه و تحلیل کنید.',
    Type: 'Story',
    Priority: 'Critical',
    Tags: 'Grid,Sql',
    Estimate: 2,
  ...
  },
  {
    ...
    Title: 'Task - 29019',
    Status: 'Validate',
    Summary: 'اعتبار سنجی مسائل مربوط به Databinding',
    Type: 'Story',
    Priority: 'Low',
    Tags: 'Validation',
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: 'Task - 29020',
    Status: 'Close',
    Summary: 'تجزیه و تحلیل کنترل شبکه',
    Type: 'Story',
    Priority: 'High',
    Tags: 'Analyze',
    Estimate: 2.5,
  ...
  },
  {
    ...
    Title: 'Task - 29021',
    Status: 'Close',
    Summary: 'رویه ذخیره شده برای اتصال داده های اولیه شبکه.',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Databinding',
    Estimate: 1.5,
  ...
  },
  {
    ...
    Title: 'Task - 29022',
    Status: 'Close',
    Summary: 'تجزیه و تحلیل رویه های ذخیره شده',
    Type: 'Story',
    Priority: 'Critical',
    Tags: 'Procedures',
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: 'Task - 29023',
    Status: 'Validate',
    Summary: 'اعتبارسنجی مشکلات ویرایش',
    Type: 'Story',
    Priority: 'Critical',
    Tags: 'Editing',
    Estimate: 1,
  ...
  },
  {
    ...
    Title: 'Task - 29026',
    Status: 'InProgress',
    Summary: 'بهبود عملکرد عملکرد ویرایش.',
    Type: 'Epic',
    Priority: 'High',
    Tags: 'Performance',
    Estimate: 6,
  ...
  },
  {
    ...
    Title: 'Task - 29027',
    Status: 'Open',
    Summary: 'برای نمایش نسخه ی نمایشی ویرایش، جلسه وب با مشتری ترتیب دهید.',
    Type: 'Others',
    Priority: 'High',
